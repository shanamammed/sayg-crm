                  ...
                  <div id="add_data">
                     <div class="form-row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="input-group">
                            <input type="text" name="last_name" class="form-control"  placeholder="Last Name" value="{{$contact->last_name}}" required>
                          ...
                          <div class="input-group">
                            <select class="form-control" name="source">
                              @foreach($sources as $source)
                               <option value="{{ $source->id }}" <?php if($source->id==$contact->source_id) {?> selected <?php };?>>{{ $source->name }}</option>
                              @endforeach
                            </select>
                          </div>
                       </div>  
                            ...
                            <select class="js-example-basic-multiple" name="companies[]" multiple="multiple"> 
                              @foreach($companies as $company)
                                @foreach($company_contacts as $cont)
                                    <option value="{{$company->id}}" @if($company->id == $cont->company_id)selected="selected"@endif>{{$company->name}}</option>
                                @endforeach
                              @endforeach
                            </select>
                          </div>
