      ...
      <div class="content-page">
        <div class="content">
          ...
          <div class="row">
            <div class="col-6">
              <div class="card-box">
                <form  id="Myform" action="{{ url('admin/roles/update/'.$role->id) }}" method="post" enctype="multipart/form-data">
                   {!! csrf_field() !!}
                  <div id="add_data">
                     <div class="form-row">
                        <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-12 mt-4">
                    <button type="submit" class="btn btn-success waves-light waves-effect w-md pull-right" id="submit-button" style="display:block;">Save</button>
                  </div>
                </div> 
